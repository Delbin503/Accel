      ...
      <div>
        ...
        {step === "reset" && (
          <>
            ...
            <p className="mt-1 text-base text-muted-foreground">Choose a strong password — at least 8 characters.</p>
        ...
        {step === "done" && (
          <div className="text-center">
            ...
            <p className="mt-1 text-base text-muted-foreground">Redirecting you to sign in…</p>
          </div>
        )}
      </div>
    </AuthLayout>
