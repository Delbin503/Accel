      ...
      <div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <Input
                ...
                placeholder="Enter your password" className="h-10 px-9 text-[13px]"
              />
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button variant="outline" className="h-10 gap-2 text-[12px]"
            onClick={() => toast.message("SSO sign-in stub", { description: "Google SSO would launch here." })}>
            <GoogleMark /> Google
          </Button>
          <Button variant="outline" className="h-10 gap-2 text-[12px]"
            onClick={() => toast.message("SSO sign-in stub", { description: "Microsoft SSO would launch here." })}>
        ...
        <p className="mt-6 text-center text-[12px] text-muted-foreground">
          ...
          <Link to="/signup" className={cn("font-semibold text-primary hover:underline")}>
            Create one
          </Link>
        </p>
      </div>
...
function GoogleMark() {
  return (
    <svg viewBox="0 0 24 24" className="size-4" aria-hidden>
      ...
      <path d="M5.84 14.1A6.61 6.61 0 0 1 5.5 12c0-.73.12-1.44.34-2.1V7.06H2.18A11 11 0 0 0 1 12c0 1.78.43 3.46 1.18 4.94l3.66-2.84Z" fill="#FBBC05" />
