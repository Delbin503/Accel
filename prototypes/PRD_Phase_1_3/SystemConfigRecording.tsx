  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <SectionCard
        ...
        description="Recording types applied to every camera — start time, end time, resolution and frame rate per type."
      >
        <RecordingSchedule />
      </SectionCard>
    </div>
...
export function SystemConfigRecording() {
  const [section, setSection] = React.useState<Section>("camera-defaults");
