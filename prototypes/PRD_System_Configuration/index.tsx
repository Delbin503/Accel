...
/* Back-to-top — the config sections run long. Tracks both the inner <main>
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-border py-24 text-center text-muted-foreground">
      ...
      <p className="text-[12px]">
        This prototype only covers <strong className="text-foreground">System Configuration</strong>.
      </p>
    </div>
  );
}
